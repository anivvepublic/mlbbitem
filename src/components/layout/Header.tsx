...
import { Moon, Sun, Menu, X, LogOut, User, LayoutGrid, Heart, Settings } from 'lucide-react'
          ...
          <div className="flex items-center flex-shrink-0 z-10 ml-[-10px] md:ml-[-70px]">
            <a href="/" className="block">
              <img
                src="/images/logo.png"
                alt="MLBBITEM"
                className="h-[140px] md:h-[200px] w-auto object-contain"
              />
            </a>
          </div>

          <nav className="hidden md:flex items-center space-x-8 ml-auto mr-8">
            <a href="/" className="text-dark-900 dark:text-text-light hover:text-primary font-medium transition-colors text-[16px]">
              Ana Sayfa
            </a>
            <a href="/marketplace" className="text-gray-600 dark:text-text-muted hover:text-primary font-medium transition-colors text-[16px]">
              Hesap Pazarı
            </a>
            <a href="/requests" className="text-gray-600 dark:text-text-muted hover:text-primary font-medium transition-colors text-[16px]">
              Talep Oluştur
            </a>
          </nav>
          ...
          <div className="flex items-center gap-3 ml-auto md:ml-0">
            {!user && (
              <>
                <button
                  onClick={openLogin}
                  className="hidden md:block px-5 py-2 border-2 border-primary text-primary font-semibold rounded-lg hover:bg-primary hover:text-white transition-colors text-[15px]"
                >
                  Giriş Yap
                </button>
                <button
                  onClick={openRegister}
                  className="hidden md:block px-5 py-2 bg-primary text-white font-semibold rounded-lg hover:bg-primary-dark transition-colors text-[15px] clip-chamfer"
                >
                  Kayıt Ol
                </button>
              </>
            ...
            <button
              onClick={toggle}
              className="p-[10px] rounded-lg bg-gray-100 dark:bg-dark-800 text-gray-600 dark:text-text-light hover:bg-gray-200 dark:hover:bg-dark-700 transition-colors"
            ...
            <button
              ...
              className="md:hidden p-[10px] rounded-lg bg-gray-100 dark:bg-dark-800 text-gray-600 dark:text-text-light"
              aria-label="Menü"
            >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 dark:border-dark-700 py-4">
            ...
            <nav className="flex flex-col space-y-1">
              <a href="/" className="text-dark-900 dark:text-text-light hover:text-primary font-medium transition-colors text-[16px] px-2 py-[10px] rounded-lg hover:bg-gray-50 dark:hover:bg-dark-800" onClick={() => setMobileMenuOpen(false)}>
                Ana Sayfa
              </a>
              <a href="/marketplace" className="text-gray-600 dark:text-text-muted hover:text-primary font-medium transition-colors text-[16px] px-2 py-[10px] rounded-lg hover:bg-gray-50 dark:hover:bg-dark-800" onClick={() => setMobileMenuOpen(false)}>
                Hesap Pazarı
              </a>
              <a href="/requests" className="text-gray-600 dark:text-text-muted hover:text-primary font-medium transition-colors text-[16px] px-2 py-[10px] rounded-lg hover:bg-gray-50 dark:hover:bg-dark-800" onClick={() => setMobileMenuOpen(false)}>
                Talep Oluştur
              </a>
            </nav>
            ...
            {user && (
              <div className="mt-3 pt-3 border-t border-gray-200 dark:border-dark-700">
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 mt-3 px-2 py-[10px] text-red-600 dark:text-red-400 font-medium text-[15px] rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
                >
            ...
            {!user && (
              <div className="flex flex-col gap-3 mt-4 pt-4 border-t border-gray-200 dark:border-dark-700">
                <button
                  ...
                  className="w-full px-5 py-3 border-2 border-primary text-primary font-semibold rounded-lg hover:bg-primary hover:text-white transition-colors text-[15px]"
                >
                  Giriş Yap
                </button>
                <button
                  onClick={() => { openRegister(); setMobileMenuOpen(false) }}
                  className="w-full px-5 py-3 bg-primary text-white font-semibold rounded-lg hover:bg-primary-dark transition-colors text-[15px] clip-chamfer"
                >
                  Kayıt Ol
                </button>
              </div>
